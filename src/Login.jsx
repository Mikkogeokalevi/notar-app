...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    setError('');
    try {
      // VAIN kirjautuminen olemassa olevalla tunnuksella
  ...
  return (
    ...
    >
      <div className="card-box" style={{ maxWidth: '400px', width: '100%', textAlign: 'center' }}>
        ...
        <div style={{ marginTop: '20px', borderTop: '1px solid #444', paddingTop: '15px', fontSize: '0.85rem', color: '#888' }}>
          Uusia käyttäjiä ei voi luoda tästä sovelluksesta. Jos tarvitset tunnuksen, ota yhteyttä ylläpitoon.
        </div>
      </div>
    </div>
  );
